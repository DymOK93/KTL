...
void (*___StlStartInitCalls__[1])(void) = {nullptr};
#pragma data_seg(".STL$L")
void (*___StlEndInitCalls__[1])(void) = {nullptr};
#pragma data_seg(".STL$M")
void (*___StlStartTerminateCalls__[1])(void) = {nullptr};
#pragma data_seg(".STL$Z")
void (*___StlEndTerminateCalls__[1])(void) = {nullptr};
#pragma data_seg()
