 ...
 public:
  ...
  static constexpr int compare(const char_type* str1,
    ...
    if constexpr (is_same_v<char_type, wchar_t>) {
      ...
      return char_traits<char_type, int_type>::compare(str1, str2, count);
    }
  }
  ...
  static static constexpr size_t length(const char_type* str) noexcept {
    if constexpr (is_same_v<char_type, wchar_t>) {
      ...
      return char_traits<char_type, int_type>::length(str);
    }
  }
  ...
  find(const char_type* str, size_t count, const char_type& ch) noexcept {
    if constexpr (is_same_v<char_type, wchar_t>) {
      ...
      return char_traits<char_type, int_type>::find(str, count, ch);
    }
  }
